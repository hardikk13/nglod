...
execute_process(
  COMMAND "/usr/bin/git" show-ref 3.2.10
  WORKING_DIRECTORY "/home/hardik/dl_exp/overfit/neuralImplicitTools/submodules/libigl/cmake/../external/eigen"
...
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 3.2.10
  WORKING_DIRECTORY "/home/hardik/dl_exp/overfit/neuralImplicitTools/submodules/libigl/cmake/../external/eigen"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/hardik/dl_exp/overfit/neuralImplicitTools/submodules/libigl/cmake/../external/eigen/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/hardik/dl_exp/overfit/neuralImplicitTools/submodules/libigl/cmake/../external/eigen/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
    execute_process(
      COMMAND "/usr/bin/git" checkout 3.2.10
      WORKING_DIRECTORY "/home/hardik/dl_exp/overfit/neuralImplicitTools/submodules/libigl/cmake/../external/eigen"
      RESULT_VARIABLE error_code
      )
    if(error_code)
